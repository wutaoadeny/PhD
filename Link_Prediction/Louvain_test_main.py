...
#import LPA_NCoreness_Q_d as ModularityQ
...
#fname = './dataset/karate.gml'
#fname = './dataset/dolphins.gml'
#fname = './dataset/lesmis.gml'
#fname = './dataset/football.gml'
#fname = './dataset/netscience.gml'
#fname = './dataset/polblog.gml'

#fname = './Datasets/1-hep-th.gml'
#fname = './Datasets/3-cond.gml'
#fname = './Datasets/4-CA-AstroPh.txt'
#fname = './Datasets/5-Email-Enron.txt'
#fname = './Datasets/7-facebook-links.txt'
#fname = './Datasets/8-flickrEdges.txt'
#fname = './Datasets/9-Gowalla_edges.txt'
#fname = './Datasets/10-com-dblp.ungraph.txt'

#fname = './Benchmark/synthetic_network/Fig0_network_7.dat' # 35 
#fname = './Benchmark/synthetic_network/Fig1_network_32.dat'  #426
#fname = './Benchmark/synthetic_network/Fig2_network_8.dat'  #
#fname = './Benchmark/synthetic_network/Fig3_network_22.dat'
#fname = './Benchmark/synthetic_network/Fig4_network_3_18.dat'
...
if __name__ == '__main__': 
	...
	print
	print "Num:",len(DrawGraph)
	Q = ModularityQ.CModularity(g, DrawGraph)
	print "Modularity:",Q
	#print DrawGraph
